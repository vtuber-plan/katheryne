...
class RewardTokenLanguageModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx: int):
        ...
        loss, chosen_mean_scores, rejected_mean_scores = self.forward(tokens=source_tokens)
...
class RewardSequenceLanguageModel(pl.LightningModule):
    def __init__(self, model: PreTrainedModel, params: HParams, pad_token_id: Optional[int]=None) -> None:
        super().__init__()
        self.params = params
    ...
    def training_step(self, batch, batch_idx: int):
        ...
        loss, chosen_rewards, rejected_rewards = self.forward(tokens=source_tokens)
